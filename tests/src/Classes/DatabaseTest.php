...
namespace Lazer\MysqlToLazerDatabase\Test\Classes;

use Lazer\MysqlToLazerDatabase\Classes\Database;
use Lazer\Classes\Database as LazerDatabase;
use Lazer\MysqlToLazerDatabase\Test\VfsHelper\Config as TestHelper;
...
class DatabaseTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @testdox Converts array to update structure and data to Lazer database: check table, fetchAll, fetch and validate data
     *
     * @covers \Lazer\MysqlToLazerDatabase\Test\Classes::create
